...
// запятой (f2) и добавления символа табуляции (\t) после каждого элемента матрицы. Таким образом, каждый элемент матрицы 
...
//      double minimum=Convert.ToDouble(minLimitRandom);
//     double maximum=Convert.ToDouble(maxLimitRandom);
//     for (int i = 0; i < m; i++)
//     {
//         for (int j = 0; j < n; j++)
//         {
//             matrix[i, j] = rand.NextDouble()*(maximum-minimum)+minimum;
//         }
//     }
//     return matrix;
//   }

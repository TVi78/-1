...
// PrintMatrix(int[,] matrix): Метод для вывода матрицы на экран. Он принимает на вход двумерный массив целых чисел matrix и
// выводит его элементы в виде таблицы.
...
// Введите свое решение ниже
    int[] temp=new int[matrix.GetLength(1)];
     for (int i = 0; i < matrix.GetLength(0); i++)
     {
        ...
        {
            matrix[i,k]=temp[matrix.GetLength(1)-1-k];
        }
     }   
    }
